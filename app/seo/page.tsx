  ...
  <div className="z-10 flex flex-col items-center justify-center">
    <div className="bg-white/20 backdrop-blur-xl">
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
        <h2 className="text-3xl font-extrabold text-blue-600 text-center items-center tracking-tight">Search Engine Optimization</h2>
        <p className="mt-4 text-xl items center text-center text-blue-600">
