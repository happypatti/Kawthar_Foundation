  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-md text-center">
        ...
        <div className="prose-sm mt-3 font-display leading-normal text-gray-500 [text-wrap:balance] md:prose">
          <ReactMarkdown
            components={{
              a: ({ node, ...props }) => (
                <a
                  ...
                  {...props}
                  className="font-display font-medium text-gray-800 underline transition-colors"
                />
              ),
              code: ({ node, ...props }) => (
                <code
